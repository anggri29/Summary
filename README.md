...
### Навигация:
#### Сценарий 1: Переход к форме записи через пролистывание всей страницы профессии.
- Используемые элементы: Скролл, кнопка "Записаться" на странице.
- Действия: Прокрутка до конца страницы, клик по кнопке "Записаться".
#### Сценарий 2: Переход к форме записи через кнопку "Записаться" на странице профессии.
- Используемые элементы: Кнопка "Записаться" на странице.
- Действия: Клик по кнопке "Записаться".
#### Сценарий 3: Переход к форме записи через меню "Каталог курсов".
...
#### Сценарий 4: Переход к форме записи через меню "Направления обучения".
- Используемые элементы: Меню "Каталог курсов", "Программирование".
...
- Валидный эмейл, состоящий из логина и домена, например, "angry.anggri@gmail.com".
#### Сценарий 5: Заполнение формы записи с действительными данными. 
...
#### Сценарии 6: Заполнение формы записи с недопустимыми данными. 
#### Сценарий 6.1. Заполнение формы записи с пустыми полями:
- Оставить поля пустыми 
- Ожидается соответствующее сообщение об ошибке или блокировка отправки формы.
#### Сценарий 6.2. Заполнение формы записи с недопустимым эмейлом:
- Ввести эмейл без домена, например: "angry.anggri".
- В остальные поля вводятся валидные данные.
- Ожидается соответствующее сообщение об ошибке или блокировка отправки формы.
#### Сценарий 6.3. Заполнение формы записи с недопустимым номером телефона:
- Ввести номер телефона в неправильном формате, например: "89250881558".
- В остальные поля вводятся валидные данные.
- Ожидается соответствующее сообщение об ошибке или блокировка отправки формы.
#### Сценарий 6.4. Заполнение формы записи с недопустимым именем:
